...
// Hooks
export const useSignificantFlowingDecimal = (flowRate, animationStepTimeInMs) =>
    useMemo(() => {
...
const useFlowingBalance = (startingBalance, startingBalanceDate, flowRate) => {
...
const FlowingBalance = memo(
    ({ startingBalance, startingBalanceDate, flowRate }) => {
        ...
        return (
            <div className="flowing-balance text-3xl flex justify-center ">
                <div className="w-[165px] m-auto">
